<%@ Page Title="Approved Claim Details" Language="C#" MasterPageFile="~/Customer.Master" AutoEventWireup="true" CodeBehind="ApprovedClaim.aspx.cs" Inherits="Singlife.ApprovedClaim" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div class="container mt-4">
        <h3 class="text-primary mb-4">Approved Claim Details</h3>
