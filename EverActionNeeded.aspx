<%@ Page Title="EverCare Action Needed" Language="C#" MasterPageFile="~/Customer.Master" AutoEventWireup="true" CodeBehind="EverActionNeeded.aspx.cs" Inherits="Singlife.EverActionNeeded" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div class="container mt-4">
        <h3 class="text-primary mb-4">Action Needed: Respond to EverCare Review</h3>
