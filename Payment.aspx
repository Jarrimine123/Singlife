...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div class="hero-container shadow-sm rounded-bottom">
        ...
        <div class="hero-text">
            ...
            <asp:Label ID="lblAmountDue" runat="server" CssClass="h4 text-warning"></asp:Label>
        </div>
    </div>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-4">
                <div class="card card-method p-4">
                    ...
                    <button type="button" class="btn btn-outline-danger btn-sm" data-bs-toggle="modal" data-bs-target="#giroModal">Setup GIRO</button>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card card-method p-4">
    ...
    <div class="modal fade" id="giroModal" tabindex="-1" aria-labelledby="giroModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">GIRO Setup</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <asp:Label ID="lblGiroMessage" runat="server" CssClass="text-danger"></asp:Label>
                    <p>Upload your GIRO form (PDF) or enter your bank account number below.</p>
                    <asp:FileUpload ID="fuGiroForm" runat="server" CssClass="form-control mb-2" />
                    <asp:TextBox ID="txtBankAccount" runat="server" CssClass="form-control" Placeholder="Bank Account Number"></asp:TextBox>
                </div>
                <div class="modal-footer">
                    <asp:Button ID="btnSubmitGiro" runat="server" CssClass="btn btn-danger" Text="Submit" OnClick="btnSubmitGiro_Click" />
