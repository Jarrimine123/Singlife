...
namespace Singlife
{
    public partial class LifeGrowRetirementPlus : System.Web.UI.Page
    {
        ...
        private void LoadReviews(string ratingFilter = "all")
        {
            using (SqlConnection conn = new SqlConnection(connStr))
            {
                ...
                {
                    cmd.Parameters.AddWithValue("@PlanName", "Lifegrow");
        ...
        private void CheckIfUserCanReview()
        {
            ...
            using (SqlConnection conn = new SqlConnection(connStr))
            {
                ...
                using (SqlCommand cmdPurchase = new SqlCommand(purchaseQuery, conn))
                {
                    ...
                    cmdPurchase.Parameters.AddWithValue("@PlanName", "Lifegrow");
                ...
                using (SqlCommand cmdReview = new SqlCommand(reviewPendingQuery, conn))
                {
                    ...
                    cmdReview.Parameters.AddWithValue("@PlanName", "Lifegrow");
