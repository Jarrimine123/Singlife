<%@ Page Title="Premium Calculator" Language="C#" MasterPageFile="~/Customer.Master" AutoEventWireup="true" CodeBehind="PremiumCalculator.aspx.cs" Inherits="Singlife.PremiumCalculator" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <h2>Retirement Premium Calculator</h2>
    <asp:Panel runat="server" CssClass="calculator-panel">

        <asp:Label ID="lblPayout" runat="server" Text="Desired Annual Payout ($):" AssociatedControlID="txtPayout" />
        <asp:TextBox ID="txtPayout" runat="server" CssClass="form-control" />
        ...
        <asp:Button ID="btnCalculate" runat="server" Text="Calculate Premium" OnClick="btnCalculate_Click" CssClass="btn btn-primary mt-2" />
