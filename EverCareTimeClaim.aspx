<%@ Page Title="" Language="C#" MasterPageFile="~/Customer.Master" AutoEventWireup="true" CodeBehind="EverCareTimeClaim.aspx.cs" Inherits="Singlife.EverCareTimeClaim" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="bg-white p-4 p-md-5 rounded shadow-sm" style="max-width: 700px; width: 100%;">
        ...
        <div class="text-center mt-4">
            <a href="EverCareClaim.aspx" class="btn btn-danger btn-lg px-5">Get started</a>
        </div>
    </div>
</div>
</asp:Content>
