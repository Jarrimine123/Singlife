...
namespace Singlife
{
    public partial class GlobalEase : System.Web.UI.Page
    {
        ...
        private void LoadReviews(string ratingFilter = "all")
        {
            using (SqlConnection conn = new SqlConnection(connStr))
            {
                ...
                {
                    cmd.Parameters.AddWithValue("@PlanName", "GlobalEase Travel Plan");
        ...
        private void CheckIfUserCanReview()
        {
            ...
            using (SqlConnection conn = new SqlConnection(connStr))
            {
                ...
                using (SqlCommand cmdPurchase = new SqlCommand(purchaseQuery, conn))
                {
                    ...
                    cmdPurchase.Parameters.AddWithValue("@PlanName", "GlobalEase Travel Plan");
                ...
                using (SqlCommand cmdReview = new SqlCommand(reviewPendingQuery, conn))
                {
                    ...
                    cmdReview.Parameters.AddWithValue("@PlanName", "GlobalEase Travel Plan");
        ...
        public string GetStarHtml(int rating)
        {
